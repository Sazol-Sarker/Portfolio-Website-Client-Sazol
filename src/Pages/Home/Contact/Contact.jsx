  ...
  return (
    ...
    >
      <div className=" flex flex-col justify-center items-center ">
        ...
        <div className="w-6/7 ml-4  text-md md:text-lg text-slate-200 flex items-center justify-center mt-2">I'll do my
        best to respond!</div>
      </div>
      {/* contact form */}
      <div className="w-full mx-auto mt-5">
        ...
        >
          ...
          <fieldset className="fieldset">
            <legend className="fieldset-legend text-white text-lg">
              My Email
            </legend>
            <input
              type="email"
          ...
          <button className="btn my-5 w-full rounded-2xl">Send Message <PiTelegramLogoLight className="text-2xl text-green-600" />
          </button>
        </form>
      </div>
    </div>
